...
function getAverage(value1, value2) {
  const averageOfTwoNumbers = value1 / 2 + value2 / 2;
...
function getHypotenuse(a, b) {
  const lengthOfHypotenuse = Math.hypot(a, b);
